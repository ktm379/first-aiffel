...
# GPT-4 발표한 오픈AI '샘 알트만', "AI가 사회를 재구성할 것이며 위험을 인정합니다, 이것이 조금 두렵습니다"<br>
<br>
...
대학생때부터 git, github를 많이 배웠지만 실질적으로 써본적은 처음이라 생각보다 오래걸렸고, markdown도 처음 써보았다.
생각보다 재미있었고, 앞으로도 프로젝트를 진행하면서 git, github를 많이 활용 해볼것같다.
